...
_magic_number = 5
_modified_time = 1298458859.7939999
_template_filename='D:\\PyProjects\\Purchase\\purchase\\templates/derived/catalog/create_section.html'
_template_uri='/derived/catalog/create_section.html'
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        __M_writer(u'\r\n\r\n\r\n')
        # SOURCE LINE 6
        __M_writer(escape(h.form_start(h.url(controller='catalog', action='create'), method="post")))
        __M_writer(u'\r\n    ')
        # SOURCE LINE 7
